      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="prose max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Delivery Partner uses cookies for a variety of reasons detailed below. Unfortunately, in most cases, there are no industry standard options for disabling cookies without completely disabling the functionality and features they add to the website. It is recommended that you leave all cookies enabled if you are unsure whether you need them or not, in case they are used to provide a service that you use.
            </p>
          </section>
          <section className="mb-8">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4 text-gray-600">
              <li>This site uses Google Analytics, one of the most widespread and trusted analytics solutions on the web, to help us understand how you use the site and ways that we can improve your experience. These cookies may track things such as how long you spend on the site and the pages that you visit.</li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-600 mb-4">
              Most web browsers allow some control of most cookies through the browser settings. To find out more about cookies, including how to see what cookies have been set and how to manage and delete them, visit <a href="https://www.allaboutcookies.org" className="text-brand-red hover:underline" target="_blank" rel="noopener noreferrer">www.allaboutcookies.org</a>.
            </p>
          </section>
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4">Cookie Consent</h2>
            <p className="text-gray-600 mb-4">
              When you first visit our website, you will be shown a cookie notice requesting your consent to set the cookies described in this policy. By clicking "Accept All Cookies," you are giving your consent for us to set cookies according to the terms of this Cookie Policy. If you prefer to control which cookies are set, you can click "Cookie Settings" to choose your preferences.
            </p>
          </section>
          <section className="mb-8">
